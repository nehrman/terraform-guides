...
resource "aws_iam_role" "lambda_read_instances" {
  name = "neh_lambda_read_instances"
	assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
...
resource "aws_iam_role" "lambda_stop_and_terminate_instances" {
  name = "neh_lambda_stop_and_terminate_instances"
	assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
...
resource "aws_iam_role_policy" "lambda_read_instances_policy" {
	name = "neh_lambda_read_instances_policy"
